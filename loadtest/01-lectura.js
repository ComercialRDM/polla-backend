...
import { BASE_URL, ESCALAS_VUS } from './common.js';
...
export default function (data) {
    const ranking = http.get(`${BASE_URL}/api/partidos/${data.partidoId}/ranking`);
    check(ranking, { 'ranking 200': (r) => r.status === 200 });

    const pozo = http.get(`${BASE_URL}/api/polla/pozo`);
